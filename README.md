...
当前处于 MVP 阶段。详细范围、架构和路线见 [总体规划](./docs/plan.md)。代码与资料的放置规则见 [项目目录结构](./docs/project-structure.md)。
...
| 文档 | 内容 |
|---|---|
| [总体规划](./docs/plan.md) | 项目定位、边界、架构和路线图 |
| [使用指南](./docs/usage.md) | 如何接入项目、同步 Skill 和验证交付 |
| [项目目录结构](./docs/project-structure.md) | 当前目录、每个模块职责和依赖关系 |
